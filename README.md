# Программа для получения данных о компаниях и вакансиях с сайта hh.ru и загрузки данных в БД PostgreSQL
...
3. Работать с результатами выгрузки вакансий с помощью пользовательских методов фильтрации данных.
...
```
git clone https://github.com/MaksimLakovich/Save-DB-hh-vacancies-by-employers.git
```
